...
func TestRfcIndexSetTargets(t *testing.T) {
	...
	docIds = rfcLabelsToDocIds(rfcIndex.GetTargets())
	assert.Equal([]string{"RFC0821", "RFC1893", "RFC2821", "RFC2852", "RFC3463", "RFC3885", "RFC4952", "RFC5337", "RFC6530", "RFC6531"}, docIds)
	rfcIndex.Clear()
...
func TestRfcIndexValues(t *testing.T) {
	...
	docIds := []string{"RFC0821", "RFC0822", "RFC0974"}
	for i := range 3 {
		assert.Equal(docIds[i], rfcs[i].DocId)
	}
}
